...
import cn.zhangbin.bean.Block;
import cn.zhangbin.bean.ColLine;
import cn.zhangbin.bean.QueryTree;
import cn.zhangbin.bean.SQLResult;
import cn.zhangbin.exception.SQLParseException;
import cn.zhangbin.exception.UnSupportedException;
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (SQLResult r :
            ...
            System.out.println(r.getOutputTables());
            System.out.println(r.getColLineList());
        }
    }
